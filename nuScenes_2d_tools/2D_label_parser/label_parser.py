            ...
            for i in tqdm(range(len(unique_img_names))):
                ...
                for idx, name in enumerate(data):
                    if unique_img_names[i] == name['filename']:
                        ...
                        if 'human' in name['category_name']:
                            ...
                            obj_class = 'car'
                        elif 'trailer' in name['category_name']:
                            obj_class = 'car'
                        
                        
                        elif 'movable_object' in name['category_name']:
                            obj_class = 'movable_object'
                        elif 'animal' in name['category_name']:
                            obj_class = 'movable_object'
                        ...
                        #     obj_class = 0
                        # elif 'human' in name['category_name']:
                        #     obj_class = 1
                        # elif 'motorcycle' in name['category_name']:
                        #     obj_class = 2
                        # elif 'car' in name['category_name']:
                        ...
                        temp = [str(obj_class), str(name['bbox_corners'][0]), str(name['bbox_corners'][1]), 
                                                str(name['bbox_corners'][2]), str(name['bbox_corners'][3]), '\n']
                        L = " "
                        L = L.join(temp)
                        f.writelines(L)
                f.close()
