...
def accumulate(gt_boxes: EvalBoxes,
    ...
    for gt_box in gt_boxes.all:
        if gt_box.detection_name in ['car', 'bus', 'truck', 'construction_vehicle', 'trailer', 'emergency']:
            gt_box.detection_name = 'car'
        elif gt_box.detection_name in ['pedestrian']:
    ...
    for box in pred_boxes.all:
        if box.detection_name in ['car', 'bus', 'truck', 'construction_vehicle', 'trailer', 'emergency']:
